...
## CoMote and R-IoT format

This package is also compatible with [R-IoT](https://github.com/ircam-ismm/riot-v3), that share the same data format.

The common format is described in [sc-motion repository](https://github.com/ircam-ismm/sc-motion/blob/main/FORMAT.md).
